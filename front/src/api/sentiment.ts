...
export function predictSentiment(params: SentimentPredictParams) { return defHttp.post<SentimentPredictResult>({ url: Api.predict, params }, { errorMessageMode: 'none' }); }
export function saveProductDraft(params: ProductDraft) { return defHttp.post({ url: Api.products, params }, { errorMessageMode: 'none' }); }
