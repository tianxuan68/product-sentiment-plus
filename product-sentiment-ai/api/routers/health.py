...
def health():
    ...
    return {
        ...
        "has_tagging": os.path.exists("./models/tagging/model/tagging_multilabel.joblib"),
        "has_tagging_bert": os.path.exists("./models/tagging/model/bert_multilabel/config.json"),
        "has_tagging_hier": os.path.exists(
            "./models/tagging/model/bert_hierarchical/hier_config.json"
        ),
