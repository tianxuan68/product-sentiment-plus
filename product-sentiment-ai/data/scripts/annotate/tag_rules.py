...
GENERAL_RULES: list[tuple[str, str, str, list[str]]] = [
    ...
    ("物流", "发货快", "positive", [
        r"发货快", r"发货很快", r"发货好快", r"发货挺快", r"发货也挺快", r"发货也很快",
        r"发货速度快", r"发货速度很快", r"发货超快", r"发货贼快",
        r"物流快", r"物流很快", r"物流好快", r"物流挺快", r"物流也挺快", r"物流也很快",
        r"物流超快", r"物流贼快",
        r"快递快", r"快递很快", r"快递好快", r"快递挺快", r"快递也挺快", r"快递超快",
        r"送货快", r"送货很快", r"送货好快", r"送货挺快", r"很快就到", r"隔天到", r"第二天到",
    ]),
    ("物流", "物流慢", "negative", [
        r"发货慢", r"发货很慢", r"发货好慢", r"发货挺慢", r"发货也挺慢",
        r"物流慢", r"物流很慢", r"物流好慢", r"物流挺慢", r"物流也挺慢",
        r"快递慢", r"快递很慢", r"快递好慢", r"等了好久", r"迟迟不到",
    ]),
    ("包装", "包装好", "positive", [r"包装好", r"包装不错", r"包装严实", r"包装完好", r"包装很好"]),
    ("包装", "包装差", "negative", [
        r"包装差", r"包装差点", r"包装有点差", r"包装不太好", r"包装不好",
        r"包装简陋", r"包装破", r"包装有点破", r"包装有点破损",
        r"破损", r"压坏", r"包装破损",
    ]),
    ("价格", "性价比高", "positive", [
...
CATEGORY_RULES: list[tuple[list[str], str, str, str, list[str]]] = [
    ...
    # 家居 / 母婴 / 家装 / 钟表礼品 / 虚拟票务 / 其他（词典与规则打标用）
    (["家居生活"], "实用", "实用方便", "positive", [r"实用", r"方便", r"好用", r"很方便"]),
    (["家居生活"], "实用", "不好用", "negative", [r"不好用", r"不实用", r"鸡肋"]),
    (["家居生活", "家具/家装/建材"], "材质", "材质不错", "positive", [r"材质好", r"材质不错", r"用料扎实"]),
    (["家居生活", "家具/家装/建材"], "材质", "材质差", "negative", [r"材质差", r"用料差", r"廉价感"]),
    (["母婴/玩具"], "安全", "安全放心", "positive", [r"安全", r"放心", r"无毒", r"通过检测"]),
    (["母婴/玩具"], "安全", "有异味", "negative", [r"有异味", r"刺鼻", r"味道冲"]),
    (["母婴/玩具"], "喜好", "孩子喜欢", "positive", [r"孩子喜欢", r"宝宝喜欢", r"小朋友喜欢"]),
    (["母婴/玩具"], "喜好", "不感兴趣", "negative", [r"不感兴趣", r"不喜欢玩", r"孩子不爱"]),
    (["家具/家装/建材"], "安装", "安装方便", "positive", [r"安装方便", r"好安装", r"安装简单"]),
    (["家具/家装/建材"], "安装", "安装麻烦", "negative", [r"安装麻烦", r"难装", r"安装复杂"]),
    (["钟表/首饰/眼镜/礼品"], "做工", "做工精致", "positive", [r"做工精致", r"做工好", r"很精致"]),
    (["钟表/首饰/眼镜/礼品"], "做工", "做工粗糙", "negative", [r"做工粗糙", r"做工差", r"毛刺"]),
    (["钟表/首饰/眼镜/礼品"], "佩戴", "佩戴舒适", "positive", [r"佩戴舒适", r"戴着舒服", r"舒适"]),
    (["钟表/首饰/眼镜/礼品"], "佩戴", "佩戴不适", "negative", [r"佩戴不适", r"戴着难受", r"勒得慌"]),
    (["机票/充值/票务/虚拟"], "到账", "到账快", "positive", [r"到账快", r"秒到", r"很快到账"]),
    (["机票/充值/票务/虚拟"], "到账", "到账慢", "negative", [r"到账慢", r"迟迟不到账", r"没到账"]),
    (["机票/充值/票务/虚拟"], "操作", "操作方便", "positive", [r"操作方便", r"很好操作", r"流程简单"]),
    (["机票/充值/票务/虚拟"], "操作", "操作麻烦", "negative", [r"操作麻烦", r"流程复杂", r"不好操作"]),
    (["其他"], "预期", "符合预期", "positive", [r"符合预期", r"和描述一致", r"如预期"]),
    (["其他"], "预期", "不符合预期", "negative", [r"不符合预期", r"和描述不符", r"货不对板"]),
]
